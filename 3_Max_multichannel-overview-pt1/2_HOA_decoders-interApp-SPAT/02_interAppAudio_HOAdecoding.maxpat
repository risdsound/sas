...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 1011.837516367435455, 172.0, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1011.837516367435455, 220.0, 29.5, 22.0 ],
					"text" : "-70."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1011.837516367435455, 139.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 634.0, 637.0, 323.0, 158.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 28.0, 637.0, 396.0, 148.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1058.0, 533.0, 150.0, 20.0 ],
					"text" : "@initwith \"/norm SN3D\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1058.0, 563.0, 287.0, 20.0 ],
					"text" : "Commas seperate individual initialization messages."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1058.0, 490.625, 564.0, 33.0 ],
					"text" : "The spat5 library allows us to use @initwith which contains \ninitialization messages with / prefixes within quotation marks such as: "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1071.837516367435455, 311.038462340831757, 114.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 634.0, 490.625, 394.0, 116.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 633.9500732421875, 447.0, 392.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1071.837516367435455, 220.0, 494.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 876.0, 920.0, 20.0 ],
					"text" : "Output channels 26 - 29 have been dropped from the DAC because these are subwoofers and need to be handled separately from the HOA decoding of the main speakers."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.0499267578125, 490.625, 410.714651925223166, 116.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.hoa.decoder~ @order 3 @outputs 25 @dimension 3D @initwith \"/norm SN3D, /speaker/number 25, /speakers/xyz 1.442 2.498 0. 2.498 1.442 0. 2.885 0. 0. 2.498 -1.442 0. 1.442 -2.498 0. 0. -2.885 0. -1.442 -2.498 0. -2.498 -1.442 0. -2.885 0. 0. -2.498 1.442 0. -1.442 2.498 0. 0. 2.885 0. 1.763 1.763 1.559 2.493 0. 1.559 1.763 -1.763 1.559 0. -2.493 1.559 -1.763 -1.763 1.559 -2.493 0. 1.559 -1.763 1.763 1.559 0. 2.493 1.559 1.152 0. 2.671 0. -1.152 2.671 -1.152 0. 2.671 0. 1.152 2.671 0. 0. 2.941\""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 28.0, 447.0, 437.627790178571331, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.hoa.rotate~ @order 3 @dimension 3D @initwith \"/yaw 90\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 634.0, 810.0, 410.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 25,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 810.0, 395.095992606026698, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 634.0, 139.0, 18.0, 20.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 130.0, 18.0, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 41.0, 762.0, 20.0 ],
					"text" : "Continuing with the \"non-mc\" and \"mc\" versions of the examples, this patch provides third order HOA decoding for the SAS loudspeaker array."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 9.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 634.0, 228.5, 323.0, 158.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 28.0, 228.5, 301.0, 145.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 634.0, 163.0, 320.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 16,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 28.0, 157.5, 301.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-2" : [ "live.gain~", "3rd order HOA 16 channels", 0 ],
			"obj-21" : [ "live.gain~[1]", "speakers", 0 ],
