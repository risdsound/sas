...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 431.837516367435455, 166.0, 72.0, 22.0 ],
					"text" : "t b b b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 54.0, 742.0, 323.0, 158.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 915.0, 410.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Adding a highpass filter to remove low frequencies from the 25 main speakers of the array."
				}
